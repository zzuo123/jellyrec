      ...
      <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex gap-1 py-2">
            <button className="px-6 py-3 rounded-t-lg bg-white dark:bg-gray-800 text-purple-600 dark:text-purple-400 font-semibold shadow-sm border-b-2 border-purple-600 dark:border-purple-500 transition-colors duration-300">
            ...
            <button className="px-6 py-3 rounded-t-lg text-gray-600 dark:text-gray-400 hover:bg-white/50 dark:hover:bg-gray-800/50 hover:text-gray-900 dark:hover:text-gray-200 font-medium transition-all">
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
